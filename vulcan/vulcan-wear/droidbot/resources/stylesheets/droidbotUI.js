...
function getEdgeDetails(edgeId) {
  ...
  // wearable info
  edgeInfo += "<table class=\"table table-striped\">\n";
  edgeInfo += "<tr><th>n</th><th>type</th><th>event_str</th></tr>\n";
  for(i = 0; i < selectedEdge.wear_events.length; i++) {
    wearEvent = selectedEdge.wear_events[i];
    wearEventType = wearEvent.event_type;
    wearEventStr = wearEvent.event_str;
    edgeInfo += "<tr><td>" + i + "</td><td>" + wearEventType + "</td><td>" + wearEventStr + "</td></tr>";
  }
  edgeInfo += "</table>\n";
