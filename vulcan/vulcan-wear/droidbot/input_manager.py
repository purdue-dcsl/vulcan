...
class InputManager(object):
    ...
    def __init__(self, device, app, policy_name, random_input,
                 ...
                 replay_output=None,
                 device_paired=None, wear_device=None):
        """
        manage input event sent to the target device
        :param device: instance of Device
        :param device_paired: instance of the Paired Device (if provided, this is a wearable device)
        :param wear_device: indicates the wearable device (either 1 or 2)
        ...
        print('\eba\ input_manager.py - __init__ policy_name: {}'.format(policy_name))
    ...
    def get_input_policy(self, device, app, master):
        if self.policy_name == POLICY_NONE:
            ...
            input_policy = UtgGreedySearchPolicy(device, app, self.random_input, self.policy_name, self.device_paired, self.wear_device)
